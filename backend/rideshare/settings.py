"""
Django settings for ride share demo project.
This file is intentionally commented to help new developers understand each section.
"""
...
if os.getenv('USE_MYSQL', 'false').lower() == 'true':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('MYSQL_DB', 'ride_share'),
...
# Send backend debug information to stdout so it appears in Render's live logs.
LOGGING = {
    'version': 1,
